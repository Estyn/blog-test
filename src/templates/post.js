        ...
        <article className="post post-full">
          ...
          {_.get(this.props, 'pageContext.frontmatter.date') &&
            <div className="post-meta">
              <time className="published" dateTime={moment(_.get(this.props, 'pageContext.frontmatter.date')).strftime('%Y-%m-%d %H:%M')}>{moment(_.get(this.props, 'pageContext.frontmatter.date')).strftime('%A, %B %e, %Y')}
              </time>
            </div>
          }
